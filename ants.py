...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        # def helper(place, current_range):
        #     if place.is_hive or current_range > self.upper_bound:
        #         return None
        #     elif current_range < self.lower_bound:
        #         return helper(place.entrance, current_range + 1)
        #     elif place.bees:
        ...
        while not current_place.is_hive:
            if self.lower_bound <= current_range <= self.upper_bound and current_place.bees:
...
class ScubaThrower(ThrowerAnt):
    """ScubaThrower should not lose its armor when placed in Water."""
    name = 'Scuba'
    food_cost = 6
    implemented = True
    is_waterproof = True
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        while current_place:
            ...
            if current_ant:
                current_ant.double()
                if isinstance(current_ant, ContainerAnt) and current_ant.ant_contained:
    ...
    def action(self, gamestate):
        ...
        if self.is_slow:
            ...
            if self.slow_turns == 0:
                self.is_slow = False
            if not gamestate.time % 2 and self.health > 0 and destination:
    ...
    def insects_in_front(self):
        ...
        while not current_place.is_hive:
            ...
            if current_place.ant and current_place.ant is not self:
                d[current_place.ant] = current_range
            current_place = current_place.entrance
            current_range += 1
        return d
        # END Problem Optional 2
